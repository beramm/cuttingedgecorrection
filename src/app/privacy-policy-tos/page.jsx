...
const PrivacyPolicyTos = () => {
  return (
    <>
      <title>Privacy Policy TOS - Cutting Edge Correction</title>
      <meta
        name="description"
        content="Read our Privacy Policy & Terms of Service for details on subscriptions, payments, cancellations, and data privacy at Cutting Edge Correction."
      />
      <div
        style={{
