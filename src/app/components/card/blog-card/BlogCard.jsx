...
const BlogCard = ({ blogData }) => {
  ...
  return (
    <Link
      ...
      passHref
      ref={ref}
      className={`w-full md:w-[280px] xl:w-[400px] max-xs:h-[516px] h-[500px] flex flex-col items-start justify-start bg-[#1F1F22] rounded-lg cursor-pointer transform hover:scale-105 transition-all ease-in-out duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
    >
