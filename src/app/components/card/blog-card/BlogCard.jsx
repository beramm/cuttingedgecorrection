...
const BlogCard = ({ blogData }) => {
  ...
  return (
      <Link
        ...
        passHref
        ref={ref}
        className={`w-full md:w-[280px] xl:w-[400px] h-[500px] flex flex-col items-start justify-start bg-[#1F1F22] rounded-lg cursor-pointer transition-all ease-in-out duration-500 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
