  ...
  return (
    <>
      <div className="h-dvh w-full flex items-center justify-end overflow-hidden 2xl:overflow-visible">
        <img
          className="fixed top-0 md:left-0 right-0 object-cover block mx-auto 2xl:mx-0 h-[1200px] 2xl:h-auto 2xl:max-h-[3000px] w-auto sm:w-full -z-20"
          src={service.landingImage} alt="Background Image"
        />
        <div className="relative top-24 md:top-auto w-full mx-8 md:mx-16 lg:mx-36 flex flex-col items-end">
      ...
      <div className="relative w-full bg-black">
        ...
        <div className="-mt-4 md:-mt-0 relative w-full flex flex-col lg:flex-row mx-auto -z-2 h-auto lg:h-[700px] justify-center items-center p-8 lg:p-0">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-start gap-x-16 h-full w-full max-w-screen-2xl">
            <div className="w-full h-full flex flex-col justify-between mt-0">
