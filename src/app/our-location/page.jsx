...
const OurLocation = () => {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Visit Cutting Edge Correction at 9/118 Bellarine Highway, Newcomb, where the magic happens. We are open 7 days a week to serve you. Contact us at 0450 649 257 or email info@cecdetailing.com.au for inquiries. "
      />
      <div
        style={{
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="hover:underline text-sm font-light mt-2">
                    <a
                      href = "https://www.google.com/maps/place/Cutting+Edge+Correction/@-38.1733169,144.3966248,18.94z/data=!4m6!3m5!1s0x6ad4118fa7bfd889:0x19eba5f83ed455b3!8m2!3d-38.1735363!4d144.3972814!16s%2Fg%2F11pwphknv6?entry=ttu&g_ep=EgoyMDI2MDcwNi4wIKXMDSoASAFQAw%3D%3D"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:underline text-sm font-light"
                    >
                      9/118 Bellarine Highway, Newcomb
                    </a>
                  </p>
                </div>
