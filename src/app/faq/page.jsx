...
const Faq = () => {
  ...
  return (
    <>
      <title>Frequently Asked Questions - Cutting Edge Correction</title>
      <meta
        name="description"
        content="Find answers to common questions about our car detailing services, including frequency, warranties, appointment duration, and gift card options."
      />
      <div className="min-h-[900px] flex flex-col items-center justify-start gap-24 w-full bg-custom-gradient px-8 md:px-12 xl:px-0 py-28">
        ...
        <div ref={ref} className={`max-w-[900px] transition-all duration-500 ease-in-out ${isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}>
          ...
          >
            ...
            <AccordionBody className="bg-primary px-8">
              Yes, we offer eGift cards, so you can digitally gift a spotless car to someone special. They are available on our
              <a href="https://cuttingedgestore.square.site/s/gift-cards" style={{ color: '#00A2FF' }} >&nbsp;store</a>
