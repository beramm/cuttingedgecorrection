...
export default function CeramicCoating() {
    return (
        <>
            <div className="h-dvh w-full flex items-center justifiy-justify-betweenn justify-start overflow-hidden 2xl:overflow-visible">
                {/* <video
                ...
                <img
                    className="absolute top-0 md:left-0 right-0 object-cover 2xl:object-contain block mx-auto 2xl:mx-0 h-[1200px] 2xl:h-auto w-auto sm:w-full z-0"
                    src="/services/Ceramic Coatings 2.jpg" alt="Background Image"
                />
                <div className="relative flex flex-col items-start justify-center w-full md:w-1/2 mx-8 md:mx-16 lg:mx-36 z-10">
                    <h1 className="hidden md:block text-6xl font-bold">CERAMIC COATING</h1>
                    ...
                    <div className="text-base mb-8 mt-8 md:mt-0 w-full max-w-full md:max-w-xl">
                        <p>
                            The Modern Armour For Your car.
                        </p>
                    </div>
                    <ContactUsButton />
                </div>
